...
'January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'Novermber',
'December')
    ...
    if user_name and user_surname and user_email and user_gender and user_new_pass and user_con_pass:
        if user_new_pass == user_con_pass:
            if click_check_btn:
                ...
                value = (
                user_name, user_surname, user_email, user_date, user_month, user_year, user_new_pass, user_gender)
